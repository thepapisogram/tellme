    ...
    <div class="row fixed-top w-100 h-100 bg-dark y-scroll m-0 p-0" id="page">
        <div class="d-none d-md-flex justify-content-center align-items-center flex-column col-7 bg-transparent m-0">
            ...
            <div id="tcl" class="rounded p-3 shadow mt-2">
                ...
                <a href="../signup" class="nav-link d-inline-flex btn btn-dark rounded border-none">Signup</a>
            </div>
        </div>
        <form class="bg-white col-10 col-md-4 col-lg-3 mx-auto my-auto shadow p-3 rounded tcf" id="login">
            <center>
                <img class="rounded-circle mb-3" id="tci" src="../assets/images/ico.png" alt="Tell-Me Logo">
            </center>
            <h2 class="text-center curl mb-2">Tell-Me</h2>
            <p class="alert alert-dark text-center p-1" id="res">Login to your account</p>
            <div class="input-group">
                <label class="d-block w-100 mb-0 font-weight-bold" for="username">Username</label>
                <input type="text" class="form-control" id="username" required>
            </div>
            <div class="input-group my-2">
                <label class="d-block w-100 mb-0 font-weight-bold" for="password">Password</label>
                <input type="password" class="form-control" id="password" required>
            </div>
            <input class="btn btn-block w-100 btn-success mt-3" type="submit" value="Log In">
            <hr>
            <a class="btn btn-outline-success w-100 mb-1" href="../signup">Create an Account</a>
